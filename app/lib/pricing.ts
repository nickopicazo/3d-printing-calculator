...
export const FDM_MATERIALS = [
  ...
  "Wood-Filled PLA",
  "Metal-Filled PLA",
  "Glow-in-the-Dark / Color-Changing PLA",
  "PETG",
  "PCTG",
  "ABS",
  "ASA",
  "Nylon (PA6 / PA12)",
  "Carbon Fiber-Filled (CF-PLA / CF-Nylon)",
  ...
  "Conductive / ESD-Safe Filament",
  "Other",
] as const;

export const SLA_MATERIALS = [
  "Standard / Model Resin",
  "ABS-Like / Tough Resin",
  "Flexible / Elastic / Rubber-Like Resin",
  "Engineering / High-Temperature Resin",
  "Water-Washable Resin",
  "Plant-Based / Eco-Friendly Resin",
  "Castable / Wax-Filled Resin (Dental/Jewelry)",
  "Dental Model / Surgical Guide Resin",
  "Clear / Optical Resin",
  "Ceramic-Filled / Rigid Resin",
  "Carbon Fiber-Infused Resin",
  "Flexible-Tough Hybrid Resin",
  "Other",
] as const;
